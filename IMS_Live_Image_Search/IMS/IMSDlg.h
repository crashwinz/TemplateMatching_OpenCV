...
#define UPDATE_TRUE_MSG  WM_USER + 1
#define UPDATE_FALSE_MSG WM_USER + 2
...
// 	CHMBitmap m_BitmapTargetImg;
	...
	afx_msg LRESULT OnReceivedUpdateDataTrue(WPARAM w, LPARAM l);
	afx_msg LRESULT OnReceivedUpdateDatafalse(WPARAM w, LPARAM l);

	////////////////////////////////////////////////// 여기까지 지울것 [2021.12.21 kyj]
	afx_msg void OnBnClickedButtonSoundFilePathSet();
};
